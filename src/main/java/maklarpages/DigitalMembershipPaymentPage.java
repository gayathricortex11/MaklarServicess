...
public class DigitalMembershipPaymentPage extends BasePage {
	...
	public static void checkFileUploadAndPaymentProcess(WebDriver driver)throws Exception
	{
		...
		//jse.executeScript("window.scrollBy(0,-1000)");
				...
				sendKeys(driver,By.xpath("//*[@id='percentage-1']"),"100");
				
				
				Thread.sleep(2000);
				waitForElement(driver,By.xpath("/html/body/div[6]/div/div/div[2]/div[3]/div/div/div/form/div[1]/div[2]/div[1]/div/div[2]/div[2]/div/div/input"));
				sendKeys(driver,By.xpath("/html/body/div[6]/div/div/div[2]/div[3]/div/div/div/form/div[1]/div[2]/div[1]/div/div[2]/div[2]/div/div/input"),"100");
				
				
				
				waitForElement(driver,By.xpath("//*[@id='other_details']/div[1]/div/div/div/div/input"));
				sendKeys(driver,By.xpath("//*[@id='other_details']/div[1]/div/div/div/div/input"),"112389122");
				
				waitForElement(driver,By.xpath("//*[@id='datepicker']"));
				sendKeys(driver,By.xpath("//*[@id='datepicker']"),"2019-11-27");
				
				waitForElement(driver,By.xpath("/html/body/div[6]/div/div/div[2]/div[3]/div/div/div/form/div[1]/div[2]/div[3]/div[3]/div/div/button"));
				click(driver,By.xpath("/html/body/div[6]/div/div/div[2]/div[3]/div/div/div/form/div[1]/div[2]/div[3]/div[3]/div/div/button"));
				
				waitForElement(driver,By.xpath("//*[@id='membership_doc']"));
				click(driver,By.xpath("//*[@id='membership_doc']"));
				Thread.sleep(1000);
				uploadFile("C:\\Users\\CCIL-SUREKHA\\document");
				Thread.sleep(1000);
				
				waitForElement(driver,By.xpath("//*[@id='agreement_doc']"));
				click(driver,By.xpath("//*[@id='agreement_doc']"));
				Thread.sleep(1000);
				uploadFile("C:\\Users\\CCIL-SUREKHA\\agreement");
				Thread.sleep(1000);
				
				waitForElement(driver,By.xpath("/html/body/div[6]/div/div/div[2]/div[3]/div/div/div/form/div[2]/div[3]/div[2]/div/div/div/div/input"));
				click(driver,By.xpath("/html/body/div[6]/div/div/div[2]/div[3]/div/div/div/form/div[2]/div[3]/div[2]/div/div/div/div/input"));
				
				waitForElement(driver,By.xpath("/html/body/div[6]/div/div/div[2]/div[3]/div/div/div/form/div[2]/div[3]/div[2]/div/div/div/div[2]/input[2]"));
				click(driver,By.xpath("/html/body/div[6]/div/div/div[2]/div[3]/div/div/div/form/div[2]/div[3]/div[2]/div/div/div/div[2]/input[2]"));
