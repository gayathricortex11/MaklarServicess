...
public class BrokerImagePdfStaticPaymentPage extends BasePage {
	...
	public static void checkFileUploadAndPaymentProcess(WebDriver driver)throws Exception
	{
		...
		Thread.sleep(1000);
		waitForElement(driver,By.xpath("//*[@id='step-2']/div/div[3]/div/div/div[3]/div/div[1]"));
		click(driver,By.xpath("//*[@id='step-2']/div/div[3]/div/div/div[3]/div/div[1]"));
		...
		//jse.executeScript("window.scrollBy(0,-1000)");
				...
				waitForElement(driver,By.xpath("//*[@id='maklarbild']/div[1]/div[1]/a"));
				click(driver,By.xpath("//*[@id='maklarbild']/div[1]/div[1]/a"));
				
				//update static payment process
				...
				Thread.sleep(1000);
				waitForElement(driver,By.xpath("/html/body/div[5]/div[2]/form/div/div[13]/div[9]/div/button[1]"));
				click(driver,By.xpath("/html/body/div[5]/div[2]/form/div/div[13]/div[9]/div/button[1]"));
